...
export default function PeopleList() {
  ...
  return (
    <div className="container px-4">
      <div>
        <h1 className="text-4xl text text-center text-red-500 font-semibold py-16">
          People List
        </h1>
      </div>
      <div className="flex gap-2 items-center px-12 py-2">
        ...
        <button
          ...
          className={`${
            currentPage === 1 ? "bg-red-300" : "bg-primary hover:bg-primary/50"
      ...
      <div className="grid grid-cols-4 gap-5 px-12 py-2">
        {data.map((e) => (
          <div
            key={e.id}
            className="w-full h-full overflow-hidden rounded-md text-white shadow-lg border border-primary hover:shadow-primary/50 hover:shadow-lg py-4"
          >
            {e.profile_path !== null ? (
              <img
              ...
              <img src="images/profile2.jpg" className="h-96 " />
            )}
            ...
            <div className="text-sm text-center mb-1">{e?.original_name}</div>
